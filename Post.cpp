...
bool Post::operator<(const Post* post_){
    Post* this_ = this;
    string this_username = this_->getUsername();
    string param_username = post_->getUsername();
    if (this_username < param_username) return true;
    return false;
}
